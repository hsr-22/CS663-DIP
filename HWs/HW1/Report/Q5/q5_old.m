clear;
clc;
im1 = double(imread("C:\Users\harsh\GitHub\CS663-DIP\HWs\HW1\T1.jpg")); im1 = im1 + 1;
im2 = double(imread("C:\Users\harsh\GitHub\CS663-DIP\HWs\HW1\T2.jpg")); im2 = im2 + 1;
...
for theta = -45:1:45
   ...
   p12 = histogram2(im1(valid_indices),im4(valid_indices),binwidth);
