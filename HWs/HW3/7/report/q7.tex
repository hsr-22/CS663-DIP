...
% Our goal is to prove that solving this PDE (i.e., running this diffusion process on the image \( I \)) is equivalent to convolving the image with a Gaussian of zero mean and some standard deviation \( \sigma \), which we will find.
...
% \subsubsection*{Solve the Differential Equation in the Frequency Domain}
...
% \subsubsection*{Determine the Standard Deviation}
